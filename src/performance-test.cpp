...
public:
    ...
    // Returns true if performance targets are met, false otherwise
...
// Returns true if all tests pass performance requirements, false otherwise
bool runPerformanceTests() {
    ...
    for (const auto& resolution : resolutions) {
        ...
        for (const auto& config : configs) {
            ...
            std::cout << std::endl;
            bool config_passed = profiler.printStatistics();
            all_tests_passed = all_tests_passed && config_passed;
        }
    }
